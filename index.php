...
<head>
    ...
    <link rel="preload" href="<?= htmlspecialchars($asset_base) ?>/style.css?v=22" as="style">
    <link rel="preload" href="<?= htmlspecialchars($asset_base) ?>/script.js?v=22" as="script">
    <link rel="stylesheet" href="<?= htmlspecialchars($asset_base) ?>/style.css?v=22">
...
<body>
    ...
    <script src="<?= htmlspecialchars($asset_base) ?>/script.js?v=22"></script>
