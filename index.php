...
<head>
    ...
    <link rel="preload" href="<?= htmlspecialchars($asset_base) ?>/style.css?v=24" as="style">
    <link rel="preload" href="<?= htmlspecialchars($asset_base) ?>/script.js?v=24" as="script">
    <link rel="stylesheet" href="<?= htmlspecialchars($asset_base) ?>/style.css?v=24">
...
<body>
    ...
    <script src="<?= htmlspecialchars($asset_base) ?>/script.js?v=24"></script>
