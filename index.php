...
<head>
    ...
    <link rel="preload" href="<?= htmlspecialchars($asset_base) ?>/style.css?v=25" as="style">
    <link rel="preload" href="<?= htmlspecialchars($asset_base) ?>/script.js?v=25" as="script">
    <link rel="stylesheet" href="<?= htmlspecialchars($asset_base) ?>/style.css?v=25">
...
<body>
    ...
    <script src="<?= htmlspecialchars($asset_base) ?>/script.js?v=25"></script>
